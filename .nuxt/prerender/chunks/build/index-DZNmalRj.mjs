import { _ as _sfc_main$1, a as _sfc_main$2 } from './ResourceGrid-cInePtrU.mjs';
import { u as useResources, _ as __nuxt_component_0 } from './server.mjs';
import { _ as _sfc_main$3 } from './CategoryCard-DTCpdiap.mjs';
import { _ as _sfc_main$4 } from './ResourceCard-BteQGqt3.mjs';
import { defineComponent, ref, computed, unref, isRef, withCtx, createTextVNode, openBlock, createBlock, createVNode, toDisplayString, useSSRContext } from 'file:///home/fmasa/Felix/Desarrollo/Frontend/stack-atlas-hub/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrRenderAttr, ssrRenderStyle } from 'file:///home/fmasa/Felix/Desarrollo/Frontend/stack-atlas-hub/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(isSearching)) {
        ...
        _push(`</div><div class="lg:col-span-3 bg-gradient-to-br from-brand-50 via-bubblegum-50 to-sunshine-50 dotted p-8 sm:p-10 lg:p-12"><div class="clay-card-flat !p-6 max-w-md mx-auto"><div class="flex items-center justify-between mb-5"><div class="flex items-center gap-3"><div class="w-10 h-10 rounded-2xl bg-brand-600 text-white shadow-clay flex items-center justify-center font-display font-bold"> AK </div><div><p class="font-display font-bold text-ink-950 text-sm">Aki&#39;s atlas</p><p class="text-xs text-ink-500">Level 7 \xB7 12-day streak</p></div></div><span class="badge-mint">+320 XP</span></div><div class="space-y-4"><!--[-->`);
...
//# sourceMappingURL=index-DZNmalRj.mjs.map
